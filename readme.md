...
|**3**| [(Gowal et al., 2020)](https://arxiv.org/abs/2010.03593)‡| WRN-28-10| 89.48| 62.80| 49.6 | 12.3 | **62.7(0.10)** |**4.28(11.58x)** |**2.10(5.85x)** |
|**4**| [(Rebuffi et al., 2021)](https://arxiv.org/abs/2103.01946)    | WRN-28-10 | 87.33 | 60.75 | 48.0 | 11.9 | **60.65(0.10)** | **4.14(11.59x)** | **2.04(5.83x)** |
|**5**| [(Sridhar et al., 2021)](https://arxiv.org/abs/2106.02078)‡ | WRN-34-15 | 86.53 | 60.41 | 47.5 | 11.8 | **60.31(0.10)** | **4.12(11.52x)** | **2.02(5.84x)** |
...
|**8**| [(Sridhar et al., 2021)](https://arxiv.org/abs/2106.02078)‡ | WRN-28-10 | 89.46 | 59.66 | 47.1 | 11.7 | **59.51(0.15)** | **4.07(11.57x)** | **2.00(5.85x)** |
|**9**| [(Carmon et al., 2019)](https://arxiv.org/abs/1905.13736)‡| WRN-28-10| 89.69| 59.53| 47.1 | 11.7 | **59.43(0.10)** | **4.07(11.57x)** | **2.00(5.85x)** |
...
|**11**| [(Addepalli, et al., 2022)](https://openreview.net/pdf?id=eFP90pzlIz) | WRN-34-10 | 85.32 | 58.04 | 45.6 | 11.3 | **57.98(0.06)** | **3.95(11.54x)** | **1.94(5.82x)** |
...
|**23**| [(Zhang et al., 2020b)](https://arxiv.org/abs/2002.11242)| WRN-34-10| 84.52| 53.51| 42.9 | 10.5 | **53.45(0.06)** | **3.66(11.72x)** | **1.80(5.83x)** |
|**24**| [(Rice et al., 2020)](https://arxiv.org/abs/2002.11569)| WRN-34-20| 85.34| 53.42| 42.1 | 10.5 | **53.35(0.07)** | **3.66(11.50x)** | **1.80(5.83x)** |
|**25**| [(Huang et al., 2020)](https://arxiv.org/abs/2002.10319)\*| WRN-34-10| 83.48| 53.34| 42.1 | 10.5 | **53.19(0.15)** | **3.64(11.57x)** | **1.79(5.87x)** |
|**26**| [(Zhang et al., 2019b)](https://arxiv.org/abs/1901.08573)\*| WRN-34-10| 84.92| 53.08| 42.0 | 10.4 | **52.99(0.09)** | **3.63(11.57x)** | **1.78(5.84x)** |
|**27**| [(Cui et al., 2020)](https://arxiv.org/abs/2011.11164)\*| WRN-34-10| 88.22| 52.86| 41.8 | 10.3 | **52.72(0.14)** | **3.62(11.55x)** | **1.78(5.79x)** |
...
|**47**| [(Kim & Wang, 2020)](https://openreview.net/forum?id=rJlf_RVKwr)| WRN-34-10| 91.51| 34.22| 28.2 | 7.8 | **34.06(0.16)** | **10.47(2.69x)** | **5.16(1.51x)** |
...
|**50**| [(Jin & Rinard, 2020)](https://arxiv.org/abs/2003.04286v1) | RN-18| 90.84| 1.35| 3.1 | 2.3 | **0.89(0.46)** | **2.24(1.38x)** | **1.09(2.11x)** |
...
|:---:|---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
|**1**| [(Gowal et al., 2020)](https://arxiv.org/abs/2010.03593)‡| WRN-70-16| 69.15| 36.88| 29.8 | 7.4 | **36.86(0.02)** | **2.54(11.73x)** | **1.24(5.97x)** |
...
| **2** | [(Engstrom, et al., 2019)](https://github.com/MadryLab/robustness) | RN-50        | 62.50 | 29.18     | 11.66  | 2.98   | **29.14(0.04)** | **2.19(5.32x)** | **1.08(2.76x)**  |
| **3** | [(Salman et al., 2020)](https://arxiv.org/abs/2007.08489)     | WRN-50-2     | 68.46 | 38.14     | 15.15  | 3.82   | **3812(0.02)**  | **2.67(5.67x)** | **1.31(2.90x)**  |
| **4** | [(Salman et al., 2020)](https://arxiv.org/abs/2007.08489)     | RN-50        | 64.10 | 34.66     | 13.78  | 3.49   | **34.60(0.06)** | **2.47(5.58x)** | **1.22(2.86x)**  |
